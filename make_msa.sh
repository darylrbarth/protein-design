...
# sequence databases
#Switching to 2021 database 
DB_UR30="$PIPE_DIR/UniRef30_2021_03/UniRef30_2021_03"
#DB_UR30="$PIPE_DIR/UniRef30_2020_06/UniRef30_2020_06"
echo "DB_UR30: $DB_UR30"
...
then
    ...
    do
        ...
        then
            echo "$HHBLITS_UR30 -i $prev_a3m -oa3m $tmp_dir/t000_.$e.a3m -e $e -v 0"
...
#Added variables to mount docker volumes
DOCKER_HOME="$PIPE_DIR:/opt/hh-suite"
DOCK="/opt/hh-suite"
DOCKER_PDB="/stor/scratch/Marcotte/RoseTTAFold-All-Atom/data/pdb100_2021Mar03:/opt/hh-suite/pdb100_2021Mar03"
PDB="/opt/hh-suite/pdb100_2021Mar03/pdb100_2021Mar03"

#Modifying to run in Docker
if [ ! -s $out_dir/t000_.hhr ]
then
    echo "Running hhsearch"
    HH="docker run -v $DOCKER_HOME -v $DOCKER_PDB soedinglab/hh-suite hhsearch -b 50 -B 500 -z 50 -Z 500 -mact 0.05 -cpu $CPU -maxmem $MEM -aliw 100000 -e 100 -p 5.0 -d $PDB"
    
    cat $out_dir/t000_.ss2 $out_dir/t000_.msa0.a3m > $out_dir/t000_.msa0.ss2.a3m
    echo "$HH -i $DOCK/$out_dir/t000_.msa0.ss2.a3m -o $DOCK/$out_dir/t000_.hhr -atab $DOCK/$out_dir/t000_.atab -v 0"
    $HH -i $DOCK/$out_dir/t000_.msa0.ss2.a3m -o $DOCK/$out_dir/t000_.hhr -atab $DOCK/$out_dir/t000_.atab -v 0
fi
...
#    cat $out_dir/t000_.ss2 $out_dir/t000_.msa0.a3m > $out_dir/t000_.msa0.ss2.a3m
#    echo "$HH -i $out_dir/t000_.msa0.ss2.a3m -o $out_dir/t000_.hhr -atab $out_dir/t000_.atab -v 0"
